...
def render_bgm_section(key_prefix=""):
    ...
    with st.container(border=True):
        ...
        from lumina_video.utils.os_util import list_resource_files
        ...
        if bgm_choice != tr("bgm.none"):
            if st.button(tr("bgm.preview"), key=f"{key_prefix}preview_bgm", width="stretch"):
                from lumina_video.utils.os_util import get_resource_path, resource_exists
                try:
...
def render_version_info():
    ...
    with st.container(border=True):
        ...
        github_url = "https://github.com/AIDC-AI/Lumina Video Studio"
        
        # Version and GitHub link in one line
        github_url = "https://github.com/AIDC-AI/Lumina Video Studio"
        badge_url = "https://img.shields.io/github/stars/AIDC-AI/Lumina Video Studio"
