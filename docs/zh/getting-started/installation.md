...
本页面将指导你完成 Lumina Video Studio 的安装。
...
1. 访问 [GitHub Releases](https://github.com/LuminaAI/Lumina-Video-Studio/releases/latest) 下载最新版本
...
浏览器应该会自动打开 `http://localhost:8501`，显示 Lumina Video Studio 的 Web 界面。
