...
只需输入一个 **主题**，Lumina Video Studio 就能自动完成：
...
1. **[安装 Lumina Video Studio](getting-started/installation.md)** - 下载并安装项目
   - 🪟 **Windows 用户推荐**: 使用 [一键整合包](https://github.com/LuminaAI/Lumina-Video-Studio/releases/latest)，无需安装 Python 环境
...
Lumina Video Studio 的设计受到以下优秀开源项目的启发：
...
- 🐛 **遇到问题**: 提交 [Issue](https://github.com/LuminaAI/Lumina-Video-Studio/issues)
- 💡 **功能建议**: 提交 [Feature Request](https://github.com/LuminaAI/Lumina-Video-Studio/issues)
...
本项目采用 Apache 2.0 许可证，详情请查看 [LICENSE](https://github.com/LuminaAI/Lumina-Video-Studio/blob/main/LICENSE) 文件。
