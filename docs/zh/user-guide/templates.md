...
视频模板使用 HTML 定义视频画面的布局和样式。Lumina Video Studio 提供了多种预设模板，覆盖不同的视频尺寸和风格需求。
...
如有模板开发相关问题，欢迎在 [GitHub Issues](https://github.com/LuminaAI/Lumina-Video-Studio/issues) 中提问。
