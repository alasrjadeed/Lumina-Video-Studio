...
[![Stars](https://img.shields.io/github/stars/LuminaAI/Lumina-Video-Studio.svg?style=flat-square)](https://github.com/LuminaAI/Lumina-Video-Studio/stargazers)
[![Issues](https://img.shields.io/github/issues/LuminaAI/Lumina-Video-Studio.svg?style=flat-square)](https://github.com/LuminaAI/Lumina-Video-Studio/issues)
[![License](https://img.shields.io/github/license/LuminaAI/Lumina-Video-Studio.svg?style=flat-square)](https://github.com/LuminaAI/Lumina-Video-Studio/blob/main/LICENSE)
...
Simply input a **topic**, and Lumina Video Studio will automatically:
...
1. **[Install Lumina Video Studio](getting-started/installation.md)** - Download and install the project
   - 🪟 **Windows Users (Recommended)**: Use the [All-in-One Package](https://github.com/LuminaAI/Lumina-Video-Studio/releases/latest), no Python installation required
...
Lumina Video Studio was inspired by the following excellent open source projects:
...
- 🐛 **Found a bug**: Submit an [Issue](https://github.com/LuminaAI/Lumina-Video-Studio/issues)
- 💡 **Feature request**: Submit a [Feature Request](https://github.com/LuminaAI/Lumina-Video-Studio/issues)
...
This project is licensed under the Apache License 2.0. See the [LICENSE](https://github.com/LuminaAI/Lumina-Video-Studio/blob/main/LICENSE) file for details.
