#!/usr/bin/env python3
"""
Windows Package Builder for Lumina Video Studio
...
class WindowsPackageBuilder:
    """Build Windows portable package for Lumina Video Studio"""
    ...
    def build(self):
        ...
        try:
            ...
            # Copy project files
            project_target = self.build_dir / "Lumina-Video-Studio"
...
def main():
    parser = argparse.ArgumentParser(description="Build Windows portable package for Lumina Video Studio")
    parser.add_argument(
        '--config',
