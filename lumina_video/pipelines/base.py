...
from lumina_video.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, lumina_video_core):
        """
        Initialize pipeline with core services
        
        Args:
            lumina_video_core: LuminaVideoCore instance (provides access to all services)
        """
        self.core = lumina_video_core
        
        # Quick access to services (convenience)
        self.llm = lumina_video_core.llm
        self.tts = lumina_video_core.tts
        self.media = lumina_video_core.media
        self.video = lumina_video_core.video
        
        # Backward compatibility alias
        self.image = lumina_video_core.media
