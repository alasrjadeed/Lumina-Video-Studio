...
from lumina_video.pipelines.base import BasePipeline
from lumina_video.models.progress import ProgressEvent
from lumina_video.models.storyboard import (
    Storyboard,
    StoryboardFrame,
    StoryboardConfig,
    ContentMetadata,
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        lumina_video.pipelines["my_custom"] = CustomPipeline(lumina_video)
    ...
    async def __call__(
        ...
        from lumina_video.utils.os_util import (
        ...
        from lumina_video.utils.template_util import resolve_template_path, get_template_type
        ...
        from lumina_video.utils.content_generators import generate_title
        ...
        # from lumina_video.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from lumina_video.utils.content_generators import generate_image_prompts
            ...
            from lumina_video.utils.prompt_helper import build_image_prompt
...
# Use immediately
lumina_video.pipelines["quick"] = QuickPipeline(lumina_video)
result = await lumina_video.generate_video(text=content, pipeline="quick")
"""
