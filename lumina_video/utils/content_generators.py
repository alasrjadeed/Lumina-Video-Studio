...
async def generate_title(
    ...
    from lumina_video.prompts import build_title_generation_prompt
...
async def generate_narrations_from_topic(
    ...
    """
    from lumina_video.prompts import build_topic_narration_prompt
...
async def generate_narrations_from_content(
    ...
    Returns:
        List of narration texts
    """
    from lumina_video.prompts import build_content_narration_prompt
...
async def generate_image_prompts(
    ...
    """
    from lumina_video.prompts import build_image_prompt_prompt
...
async def generate_video_prompts(
    ...
    """
    from lumina_video.prompts.video_generation import build_video_prompt_prompt
