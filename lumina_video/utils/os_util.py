...
def get_lumina_video_root_path() -> str:
    """
...
def ensure_lumina_video_root_path() -> str:
    """
    Ensure Lumina Video Studio root path exists and return the path
    
    Returns:
        Root path as string
    """
    root_path = get_lumina_video_root_path()
...
def get_root_path(*paths: str) -> str:
    """
    Get path relative to Lumina Video Studio root path
    ...
    """
    root_path = ensure_lumina_video_root_path()
    if paths:
...
def get_temp_path(*paths: str) -> str:
    """
    Get path relative to Lumina Video Studio temp folder
...
def get_data_path(*paths: str) -> str:
    """
    Get path relative to Lumina Video Studio data folder
...
def get_output_path(*paths: str) -> str:
    """
    Get path relative to Lumina Video Studio output folder
