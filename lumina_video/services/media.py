...
class MediaService(ComfyBaseService):
    ...
    Usage:
        ...
        media = await lumina_video.media(
            prompt="a cat",
            workflow="image_flux.json"
        )
        
        # List available workflows
        workflows = lumina_video.media.list_workflows()
    """
    ...
    def __init__(self, config: dict, core=None):
        ...
        Args:
            ...
            core: LuminaVideoCore instance (for accessing shared ComfyKit)
        """
    ...
    def _scan_workflows(self):
        ...
        """
        from lumina_video.utils.os_util import list_resource_dirs, list_resource_files, get_resource_path
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            media = await lumina_video.media(prompt="a beautiful cat")
            if media.is_image:
