...
class ImageAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await lumina_video.image_analysis("path/to/image.jpg")
        
        # Use local ComfyUI
        description = await lumina_video.image_analysis(
            "path/to/image.jpg",
            source="selfhost"
        )
        
        # List available workflows
        workflows = lumina_video.image_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await lumina_video.image_analysis("temp/06.JPG")
