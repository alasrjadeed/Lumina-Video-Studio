...
class VideoAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await lumina_video.video_analysis("path/to/video.mp4")
        
        # Use local ComfyUI (future)
        description = await lumina_video.video_analysis(
            "path/to/video.mp4",
            source="selfhost"
        )
        
        # List available workflows
        workflows = lumina_video.video_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await lumina_video.video_analysis("temp/01_segment.mp4")
        ...
        """
        from lumina_video.utils.workflow_util import resolve_workflow_path
