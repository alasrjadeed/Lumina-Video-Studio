...
from lumina_video.models.media import MediaResult
from lumina_video.utils.os_util import get_output_path


class APIProviderMediaService:
    """Adapter from Lumina media calls to direct provider API clients."""
    ...
    VIDEO_MODEL_CAPABILITIES: dict[tuple[str, str], dict[str, Any]] = {
        ...
        ("dashscope", "wan2.7-i2v"): {
            ...
            "contract_issues": [
                "Lumina UI exposes first-frame image-to-video; asset-based workflow can optionally pass narration audio as driving_audio.",
    ...
    async def _generate_image(
        ...
        **params,
        ...
        from lumina_video.services.api_services.image_client import ImageClient
        ...
        session_id = params.get("session_id") or "lumina"
    ...
    async def _generate_video(
        ...
        **params,
        ...
        from lumina_video.services.api_services.video_client import VideoClient
...
""".strip()
    ...
    def _video_options(
        ...
        """Map Lumina.s generic video params to provider client options."""
