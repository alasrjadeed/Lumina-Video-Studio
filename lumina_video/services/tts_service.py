...
from lumina_video.utils.tts_util import edge_tts
from lumina_video.tts_voices import speed_to_rate
...
class TTSService(ComfyBaseService):
    ...
    Usage:
        ...
        audio_path = await lumina_video.tts(text="Hello, world!")
        
        # Use specific workflow
        audio_path = await lumina_video.tts(
            text="你好，世界！",
            workflow="tts_edge.json"
        )
        
        # List available workflows
        workflows = lumina_video.tts.list_workflows()
    """
