...
from .schema import LuminaVideoConfig
...
class ConfigManager:
    ...
    def __init__(self, config_path: str = "config.yaml"):
        ...
        self.config: LuminaVideoConfig = self._load()
        self._initialized = True
    
    def _load(self) -> LuminaVideoConfig:
        """Load configuration from file"""
        data = load_config_dict(str(self.config_path))
        config = LuminaVideoConfig(**data)
    ...
    def update(self, updates: dict):
        ...
        self.config = LuminaVideoConfig(**merged)
    ...
    def set_llm_config(self, api_key: str, base_url: str, model: str):
        ...
        from lumina_video.utils.llm_util import normalize_openai_base_url
